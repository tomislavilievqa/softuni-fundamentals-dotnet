...
namespace _6._Store_Boxes
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //storeBoxes.OrderByDescending(storeBoxes => storeBoxes.PriceForABox).Select(box => box.ToString()).ToList().ForEach(x => Console.WriteLine(x));
            
            
            // second version
            List<Box> sortedBox = storeBoxes.OrderByDescending(storeBoxes => storeBoxes.PriceForABox).ToList();
